...
---
---
title: "Beta and Gamma Functions: Definitions, Properties, Relationship, and Applications in Civil Engineering"
format: pdf
---
...
# Gamma Function
The Gamma function, denoted as $\Gamma(z)$, is defined for $\text{Re}(z) > 0$ by the improper integral:

$$
\Gamma(z) = \int_0^\infty t^{z-1} e^{-t} \, dt
$$

For $z = n$, where $n$ is a positive integer, the definition becomes:
...
To derive the reduction formula $\Gamma(z+1) = z \Gamma(z)$, we start from the definition:
...
$$
u = t^z \quad \text{and} \quad dv = e^{-t} \, dt
$$
$$
du = z t^{z-1} \, dt \quad \text{and} \quad v = -e^{-t}
$$

Then,
$$
\Gamma(z+1) = \left. -t^z e^{-t} \right|_0^\infty + \int_0^\infty z t^{z-1} e^{-t} \, dt
$$

The boundary term $\left. -t^z e^{-t} \right|_0^\infty$ evaluates to 0, since $t^z e^{-t}$ tends to 0 as $t$ approaches both 0 and $\infty$. Thus,
